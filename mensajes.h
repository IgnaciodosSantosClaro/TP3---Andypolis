...
const string COORDENADA_HABITADA = "El casillero seleccionado se encuentra ocupado por un jugador.";
...
const string ENERGIA_INSUFICIENTE = "La cantidad de enegia es insuficiente.";
const string ANDYCOINS_INSUFICIENTES = "La cantidad de andycoins es insuficiente.";
// Matriz.h
...
const string MENSAJE_TRANSITABLES_COMPLETO = "Se despejaron las nubes : No hay casilleros transitables libres para que lluevan materiales.";
