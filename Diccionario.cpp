...
void Diccionario::recorrer() {//imprime por pantalla el recorrido in order con las claves de cada nodo del ABB
...
void Diccionario::reemplazar(string viejo, Edificio* edificio) {
    ...
    aux->~Nodo_ABB(); //borro la memtoria que ocupaba el dato viejo
